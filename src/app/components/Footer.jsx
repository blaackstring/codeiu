      ...
      <div className="max-w-6xl mx-auto px-5 flex flex-col md:flex-row justify-between items-start gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li>
              <a href="/login" className="text-gray-300 hover:text-purple-400 transition-colors">Login</a>
            </li>
            <li>
              <a href="/signup" className="text-gray-300 hover:text-pink-400 transition-colors">Sign Up</a>
            </li>
          </ul>
        </div>
        {/* Contact Info */}
